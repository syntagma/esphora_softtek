...
<form name="frmAltaCompra" method="post" action="<?php echo $_SERVER['SCRIPT_NAME']."?".$_SERVER['QUERY_STRING']; ?>">

	<input name="id_afip" id="hidIdAfip" type="hidden">
	<input name="id_compra" type="hidden" value="<?php echo $edicion['id_compra']; ?>">
	<input name="id_empresa" type="hidden" value="<?php echo ($edicion['id_empresa'] != null ? $edicion['id_empresa'] : GLOBAL_EMPRESA); ?>">

	<table width="200" border="0">
  		<tr>
    		<td nowrap align="right">
    			<?php echo Translator::getTrans("proveedor"); ?>    		</td>
    		<td nowrap align="left">
    			<input name="id_proveedor" id="txt_id_proveedor" type="hidden" value="<?php echo $edicion['id_proveedor']; ?>">
        			...
        			<tr>
            			<td nowrap>
            				<input 
            					...
            					type="text"  
            					id="txt_descripcion_proveedor" 
            					value="<?php echo $edicion['descripcion_proveedor']; ?>" 
            					maxlength="50" 
            					disabled readonly 
            				/>            			</td>
            			...
            			<td nowrap>
            				<input 
            					name="btnSelectVendor" 
            					type="button" 
            					value="..." 
            					style="width:18px;height:23px" 
            					onClick="$('lista_proveedores').style.display = 'block';"
            				/>            			</td>
            		</tr>
        		</table>
        
        		<div id="lista_proveedores" class="lista_flotante">
       				<table>
       					<tr>
       						...
       						<td>
       							<button 
       								type="button" 
       								onclick="buscaProveedor($('txt_search_razonSocial').value, 'contenedor_proveedores', this);"
       							>Search...</button>       						</td>
       					</tr>
       				</table>
       				<br>
 	        		<div id="contenedor_proveedores"></div>
	        		<a href="javascript:close('lista_proveedores');"><?php echo Translator::getTrans("CLOSE"); ?></a>	        	</div>	        </td>
    
    		<td nowrap>
    			<div class="div_error_req" id="div_error_req_descripcion_proveedor"><?php echo Translator::getTrans("REQUIRED"); ?></div>			</td>
  		...
  		<tr>
    		...
    		<td nowrap align="left">
    			<input 
    				...
    				id="txt_nro_compra" 
    				readonly
    				value="<?php echo $edicion['nro_compra'] == null ? "" : str_pad($edicion['nro_compra'], 8, "0", STR_PAD_LEFT); ?>" 
    				maxlength="8"
    			/>			</td>

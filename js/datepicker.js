...
var dayArrayLong = new Array('Domingo', 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Sabado', 'Domingo');
...
function refreshDatePicker(dateFieldName, year, month, day)
{
  ...
  do {
    ...
    // increment the day
    auxDay = thisDay.getDate();
    thisDay.setDate(thisDay.getDate() + 1);
    if (thisDay.getDate() == auxDay) thisDay.setDate(thisDay.getDate() + 1);
  ...
  var today = new Date();
  var todayString = "Hoy es " + dayArrayMed[today.getDay()] + ", " + monthArrayMed[ today.getMonth()] + " " + today.getDate();
